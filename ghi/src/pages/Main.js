    ...
    <>
      <div className="container-fluid">
        ...
        <div className="banner">
          <div>
            <img className="banner-image" src={banner1} alt="banner with logo" />
          ...
          <div className="text-section">
            <div className="row">
              <div className="col-sm-5 col-md-6">
                ...
                <div className="blurb">
                  <p>
                    If you drive somewhere and find that you can't drive when it's time to leave,
                    or you just don't feel like it (we've all been there), book a ride and one of
                    our drivers will come drive you wherever you need to go. With our fleet of 
                    autonomous vehicles, there's no need for a second driver. Once your ride is
                    complete, one of our self-driving cars will pick your driver up. 
                  </p>
                </div>
              </div>
              ...
              <div id="carouselExampleAutoplaying" className="carousel slide" data-bs-ride="carousel">
                <div className="carousel-inner">
                  <div className="carousel-item active">
                    <img src={anita} class="d-block w-100" alt="..." style={{borderRadius: 15}} />
                  </div>
                  <div className="carousel-item">
                    <img src={alvin} class="d-block w-100" alt="..." style={{borderRadius: 15}} />
                  </div>
                  <div className="carousel-item">
                    <img src={couple} class="d-block w-100" alt="..." style={{borderRadius: 15}} />
                  </div>
                </div>
