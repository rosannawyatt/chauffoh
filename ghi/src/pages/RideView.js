    ...
    <div className="container mt-4">
            ...
            <table className="table table-striped">
                ...
                <tbody>
                            <tr>
                                <td>{ride && ride.id}</td>
                                <td>{ride.account && ride.account.first_name} {ride.account && ride.account.last_name}</td>
                                ...
                                <td>{ride.driver && ride.driver.first_name ? ride.driver.first_name : 'Not Assigned'} {ride.driver && ride.driver.last_name}</td>
                            </tr>
                </tbody>
            </table>
        </div>)
